...
{{--                <img src="{{asset('img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">--}}
                <span class="ms-1 font-weight-bold text-white">Teacher</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <ul class="nav  nav-sidebar flex-column" data-widget="treeview" role="menu" >
                    <li class="nav-item">
                        <a class="nav-link text-white active bg-gradient-primary" href="{{'CurseTeacher'}}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="material-icons opacity-10">Curse</i>
                            </div>
                            <span class="nav-link-text ms-1">CurseTeacher</span>
                        </a>
                    </li>
                </ul>
                {{--<li class="nav-item">
